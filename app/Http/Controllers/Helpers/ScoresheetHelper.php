        ...
        if ($published) {
            ...
            switch ($category) {
                ...
                case 'HI':
                    ...
                    $labelList['score08'] = 'Does the aspect of mystery/suspense blend with the romantic historical theme?';
                    $labelList['score09'] = 'Do the historical elements draw you into the overall setting?';
                    $labelList['score10'] = 'Are the characters skillfully developed?';
                    $labelList['score11'] = 'Are the characters appropriate to the plot?';
                    $labelList['score12'] = 'Are the characters at home in their time, or are there 21st century "drop-ins" with 21st century agendas?';
                    $labelList['score13'] = 'In the opening pages, is there an idea or foreshadow of the relationship to come?';
                    $labelList['score14'] = 'Are the characters\' actions and reactions believable?';
                ...
                case 'PA':
                    ...
                    $labelList['score11'] = 'Are the characters\' actions and reactions believeable?';
                    ...
                    $labelList['score14'] = 'Is the author\'s concept of world building believeable?';
                ...
                case 'ST':
                    ...
                    $labelList['score07'] = 'Are the characters skillfully developed?';
                    $labelList['score08'] = 'Are the characters appropriate to the plot?';
                    $labelList['score09'] = 'Are the character\'s actions and reactions believable?';
                ...
                case 'IN':
                    ...
                    $labelList['score08'] = 'Is the premise on which the story is created solid enough to build the story to its ultimate climax?';
                    $labelList['score09'] = 'Is the story presented in a manner that is uplifting, yet not condescending or preachy?';
                    $labelList['score10'] = 'Are the characters skillfully developed?';
                    $labelList['score11'] = 'Are the characters appropriate to the plot?';
                    $labelList['score12'] = 'Do you get a sense of the hero/heroine\'s values, belief system or lack thereof?';
                    $labelList['score13'] = 'Is there chemistry between the hero and heroine?';
                    $labelList['score14'] = 'Is there a good balance between dialogue and narrative?';
                    $labelList['score15'] = 'Does the dialogue progress the story and help build the suspense?';
                    $labelList['score16'] = 'Does the narrative progress the story and help build the suspense?';
                    $labelList['score17'] = 'Does the dialogue ring true (normal and conversational, not too stiff and unnatural)?';
