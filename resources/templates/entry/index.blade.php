...
@section('content')
    @if((Carbon::now()>= Carbon::create(2016,1,15,0,0,0,'America/Denver')) && (Carbon::now()< Carbon::create(2016,3,16,0,0,0,'America/Denver')))
    ...
    @else
        <h4><strong>The competition entry period has ended</strong></h4>
    @endif
