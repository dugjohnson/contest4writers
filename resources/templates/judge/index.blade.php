...
@section('content')
    ...
    <p>If you are an editor, agent or publisher of fiction for anything other than your own work, we appreciate your interest, but will have to ask you to pass.</p>
    @if($isJudge)
