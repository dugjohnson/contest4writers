<fieldset>
    ...
    <p>Comments: {{ $scoresheet->sheet->comments->comment01 }} </p>
...
<fieldset>
    ...
    <p>Comments: {{ $scoresheet->sheet->comments->comment05 }} </p>
...
<fieldset>
    ...
    <p>Comments: {{ $scoresheet->sheet->comments->comment07 }} </p>
...
<fieldset>
    ...
    <p>Comments: {{ $scoresheet->sheet->comments->comment10 }} </p>
    <p>{{ $label['score11'] }} {{ $scoresheet->sheet->scores->score11 }} </p>
    <p>Comments: {{ $scoresheet->sheet->comments->comment11 }} </p>
...
<fieldset>
    ...
    <p>Comments: {{ $scoresheet->sheet->comments->comment13 }} </p>
    <p>{{ $label['score14'] }} {{ $scoresheet->sheet->scores->score14 }} </p>
    <p>Comments: {{ $scoresheet->sheet->comments->comment14 }} </p>
    <p>{{ $label['score15'] }} {{ $scoresheet->sheet->scores->score15 }} </p>
    <p>Comments: {{ $scoresheet->sheet->comments->comment15 }}</p>
</fieldset>

<fieldset>
    <legend>DIALOGUE/NARRATIVE</legend>
    <p>{{ $label['score16'] }} {{ $scoresheet->sheet->scores->score16 }} </p>
    <p>Comments: {{ $scoresheet->sheet->comments->comment16 }} </p>
