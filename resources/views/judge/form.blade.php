        ...
        @else
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {!! Form::radio('judgeThisYear','LJ', $judge->judgeThisYear=='LJ', ['class' => 'form-control']) !!}
                    I would love to judge this year<br/>
                    {!! Form::radio('judgeThisYear','NY', $judge->judgeThisYear=='NY', ['class' => 'form-control']) !!}
                    I am not able to judge this year<br/>
                    <!-- {!! Form::radio('judgeThisYear','EJ', $judge->judgeThisYear=='EJ', ['class' => 'form-control']) !!} Only use me in an emergency<br/> -->
                    {!! Form::radio('judgeThisYear','RM', $judge->judgeThisYear=='RM', ['class' => 'form-control']) !!}
                    Please remove me from judging list<br/>
                </div>
                <div></div>
            </div>
                    ...
                    @else
                        <div class="form-group">
                            ...
                            <p> {!! Form::label('emergencyJudgeUnpub', 'I am willing to be an emergency judge for Unpublished:') !!}
                                {!! Form::radio('emergencyJudgeUnpub','T', $judge->emergencyJudgeUnpub==true, ['class' => 'form-control']) !!}
                                Yes
                                {!! Form::radio('emergencyJudgeUnpub','F', $judge->emergencyJudgeUnpub===false, ['class' => 'form-control']) !!}
                                No</p>

                            <p>            {!! Form::label('emergencyJudgePub', 'I am willing to be an emergency judge for Published:') !!}
                                {!! Form::radio('emergencyJudgePub','T', $judge->emergencyJudgePub===true, ['class' => 'form-control']) !!}
                                Yes
                                {!! Form::radio('emergencyJudgePub','F', $judge->emergencyJudgePub===false, ['class' => 'form-control']) !!}
                                No</p>
                        </div>
                        ...
                        <div class="form-group">
                            {!! Form::label('cozy', 'Cozy:') !!}
                            {!! Form::select('cozy', $preferenceLevels ,$judge->cozy , ['class' => 'form-control']) !!}
                        </div>
                        <p>I’d be happy to judge a story with these elements</p>
                        <!-- Erotic Form Input -->
                        <div class="form-group">
                            {!! Form::label('erotic', 'Sex/sensuality on the page:') !!}
                            {!! Form::radio('erotic',true, $judge->erotic==true, ['class' => 'form-control']) !!}
                            Yes {!! Form::radio('erotic',false, $judge->erotic==false, ['class' => 'form-control']) !!}
                            No
                        </div>
                        <div class="form-group">
                            {!! Form::label('glbt', 'LGBTQ+:') !!}
                            {!! Form::radio('glbt',true, $judge->glbt==true, ['class' => 'form-control']) !!}
                            Yes {!! Form::radio('glbt',false, $judge->glbt==false, ['class' => 'form-control']) !!} No
                        </div>
                        <div class="form-group">
                            {!! Form::label('bdsm', 'Violence (including physical and sexual assault) on the page:') !!}
                            {!! Form::radio('bdsm',true, $judge->bdsm==true, ['class' => 'form-control']) !!}
                            Yes {!! Form::radio('bdsm',false, $judge->bdsm==false, ['class' => 'form-control']) !!} No
                        </div>
                        <div class="form-group">
                            {!! Form::label('childdeath', 'Child death/near death on the page:') !!}
                            {!! Form::radio('childdeath',true, $judge->childdeath==true, ['class' => 'form-control']) !!}
                            Yes {!! Form::radio('childdeath',false, $judge->childdeath==false, ['class' => 'form-control']) !!}
                            No
                        </div>
