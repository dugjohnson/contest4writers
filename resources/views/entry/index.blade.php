...
@section('content')
    @if(($app->environment('local') || Carbon::now()>= Carbon::create($contest_year,1,15,0,0,0,'America/Denver')) && (Carbon::now()< Carbon::create($contest_year,3,16,0,0,0,'America/Denver')))
